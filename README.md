...
**Bez registracije. Bez plaćanja. Podaci ne odlaze nigdje.**
...
| `rjecnik.html` | Stručni rječnik, 140 izraza bosanski–njemački, sa pretragom |
| `style.css` | Izgled, zajednički za sve stranice |

## Kako radi

Sve je obična HTML stranica bez servera i bez baze podataka. Životopis se
sastavlja i prikazuje **u pregledniku korisnika** — nijedan podatak se ne šalje
na internet i ništa se ne pamti. PDF se pravi kroz štampu preglednika
(`Sačuvaj kao PDF`).
